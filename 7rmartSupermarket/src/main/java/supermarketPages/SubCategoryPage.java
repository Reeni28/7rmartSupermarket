...
public class SubCategoryPage {
	...
	@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/list-sub-category']")WebElement subcategory;
	@FindBy(xpath="//a[@onclick='click_button(1)']")WebElement subcatnewbutton;
	@FindBy(xpath="//select[@id='cat_id']")WebElement selectcategorydropdown;
	@FindBy(xpath="//input[@id='subcategory']")WebElement subcategoryvalue;
	@FindBy(xpath="//input[@id='main_img']")WebElement inputimage;
	@FindBy(xpath="//button[contains(@name,'create')]")WebElement savesubcategory;
