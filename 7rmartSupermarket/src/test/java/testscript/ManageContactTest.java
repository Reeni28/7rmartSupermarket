...
public class ManageContactTest extends Base{
  ...
  public void updatemanagecontact() throws IOException {
	  ...
	  managecontactpage.editactionclick().inputphonenumber(phonenumber).inputemailaddress(emailaddress).inputaddress(addressdetails).inputdeliverytime(deliverytimevalue).inputdeliverycharge(deliverycharge).updatebuttonclick();
