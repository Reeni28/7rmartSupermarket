...
public class ManageCategoryTest extends Base{
  ...
  public void addcategoryvalues() throws IOException{
	  ...
	  managecategorypage.manageclick().newclick().entercategoryvalue(value).selectgroup().chooseimagevalue().checktopradiobutton().checkleftradiobutton().categorysavebutton();
